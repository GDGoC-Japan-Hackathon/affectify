...
func newProjectMember(db *gorm.DB, opts ...gen.DOOption) projectMember {
	...
	_projectMember.projectMemberDo.UseModel(&entity.ProjectMember{})
...
type projectMember struct {
	projectMemberDo projectMemberDo
...
func (p *projectMember) WithContext(ctx context.Context) IProjectMemberDo {
	return p.projectMemberDo.WithContext(ctx)
}

func (p projectMember) TableName() string { return p.projectMemberDo.TableName() }

func (p projectMember) Alias() string { return p.projectMemberDo.Alias() }

func (p projectMember) Columns(cols ...field.Expr) gen.Columns {
	return p.projectMemberDo.Columns(cols...)
}
...
type IProjectMemberDo interface {
	...
	Create(values ...*entity.ProjectMember) error
	CreateInBatches(values []*entity.ProjectMember, batchSize int) error
	Save(values ...*entity.ProjectMember) error
	First() (*entity.ProjectMember, error)
	Take() (*entity.ProjectMember, error)
	Last() (*entity.ProjectMember, error)
	Find() ([]*entity.ProjectMember, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*entity.ProjectMember, err error)
	FindInBatches(result *[]*entity.ProjectMember, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*entity.ProjectMember) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*entity.ProjectMember, error)
	FirstOrCreate() (*entity.ProjectMember, error)
	FindByPage(offset int, limit int) (result []*entity.ProjectMember, count int64, err error)
...
func (p projectMemberDo) Create(values ...*entity.ProjectMember) error {
	if len(values) == 0 {
		return nil
	}
...
func (p projectMemberDo) CreateInBatches(values []*entity.ProjectMember, batchSize int) error {
	return p.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (p projectMemberDo) Save(values ...*entity.ProjectMember) error {
	if len(values) == 0 {
		return nil
	}
...
func (p projectMemberDo) First() (*entity.ProjectMember, error) {
	if result, err := p.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*entity.ProjectMember), nil
	}
}

func (p projectMemberDo) Take() (*entity.ProjectMember, error) {
...
func (p projectMemberDo) Last() (*entity.ProjectMember, error) {
...
func (p projectMemberDo) Find() ([]*entity.ProjectMember, error) {
	result, err := p.DO.Find()
	return result.([]*entity.ProjectMember), err
}

func (p projectMemberDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*entity.ProjectMember, err error) {
	buf := make([]*entity.ProjectMember, 0, batchSize)
...
func (p projectMemberDo) FindInBatches(result *[]*entity.ProjectMember, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (p projectMemberDo) FirstOrInit() (*entity.ProjectMember, error) {
...
func (p projectMemberDo) FirstOrCreate() (*entity.ProjectMember, error) {
...
func (p projectMemberDo) FindByPage(offset int, limit int) (result []*entity.ProjectMember, count int64, err error) {
...
func (p projectMemberDo) Delete(models ...*entity.ProjectMember) (result gen.ResultInfo, err error) {

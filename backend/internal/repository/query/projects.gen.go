...
func newProject(db *gorm.DB, opts ...gen.DOOption) project {
	...
	_project.projectDo.UseModel(&entity.Project{})
	...
	_project.OwnerID = field.NewInt64(tableName, "owner_id")
...
func (p *project) updateTableName(table string) *project {
	...
	p.OwnerID = field.NewInt64(table, "owner_id")
...
type IProjectDo interface {
	...
	Unscoped() IProjectDo
	Create(values ...*entity.Project) error
	CreateInBatches(values []*entity.Project, batchSize int) error
	Save(values ...*entity.Project) error
	First() (*entity.Project, error)
	Take() (*entity.Project, error)
	Last() (*entity.Project, error)
	Find() ([]*entity.Project, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*entity.Project, err error)
	FindInBatches(result *[]*entity.Project, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*entity.Project) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*entity.Project, error)
	FirstOrCreate() (*entity.Project, error)
	FindByPage(offset int, limit int) (result []*entity.Project, count int64, err error)
...
func (p projectDo) Create(values ...*entity.Project) error {
	if len(values) == 0 {
		return nil
	}
...
func (p projectDo) CreateInBatches(values []*entity.Project, batchSize int) error {
	return p.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (p projectDo) Save(values ...*entity.Project) error {
	if len(values) == 0 {
		return nil
	}
...
func (p projectDo) First() (*entity.Project, error) {
...
func (p projectDo) Take() (*entity.Project, error) {
...
func (p projectDo) Last() (*entity.Project, error) {
...
func (p projectDo) Find() ([]*entity.Project, error) {
	result, err := p.DO.Find()
	return result.([]*entity.Project), err
}

func (p projectDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*entity.Project, err error) {
	buf := make([]*entity.Project, 0, batchSize)
...
func (p projectDo) FindInBatches(result *[]*entity.Project, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (p projectDo) FirstOrInit() (*entity.Project, error) {
...
func (p projectDo) FirstOrCreate() (*entity.Project, error) {
...
func (p projectDo) FindByPage(offset int, limit int) (result []*entity.Project, count int64, err error) {
...
func (p projectDo) Delete(models ...*entity.Project) (result gen.ResultInfo, err error) {

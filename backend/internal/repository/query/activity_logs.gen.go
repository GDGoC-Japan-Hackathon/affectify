...
func newActivityLog(db *gorm.DB, opts ...gen.DOOption) activityLog {
	...
	_activityLog.activityLogDo.UseModel(&entity.ActivityLog{})
...
type IActivityLogDo interface {
	...
	Create(values ...*entity.ActivityLog) error
	CreateInBatches(values []*entity.ActivityLog, batchSize int) error
	Save(values ...*entity.ActivityLog) error
	First() (*entity.ActivityLog, error)
	Take() (*entity.ActivityLog, error)
	Last() (*entity.ActivityLog, error)
	Find() ([]*entity.ActivityLog, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*entity.ActivityLog, err error)
	FindInBatches(result *[]*entity.ActivityLog, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*entity.ActivityLog) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*entity.ActivityLog, error)
	FirstOrCreate() (*entity.ActivityLog, error)
	FindByPage(offset int, limit int) (result []*entity.ActivityLog, count int64, err error)
...
func (a activityLogDo) Create(values ...*entity.ActivityLog) error {
	if len(values) == 0 {
		return nil
	}
...
func (a activityLogDo) CreateInBatches(values []*entity.ActivityLog, batchSize int) error {
	return a.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (a activityLogDo) Save(values ...*entity.ActivityLog) error {
	if len(values) == 0 {
		return nil
	}
...
func (a activityLogDo) First() (*entity.ActivityLog, error) {
	if result, err := a.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*entity.ActivityLog), nil
	}
}

func (a activityLogDo) Take() (*entity.ActivityLog, error) {
...
func (a activityLogDo) Last() (*entity.ActivityLog, error) {
...
func (a activityLogDo) Find() ([]*entity.ActivityLog, error) {
	result, err := a.DO.Find()
	return result.([]*entity.ActivityLog), err
}

func (a activityLogDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*entity.ActivityLog, err error) {
	buf := make([]*entity.ActivityLog, 0, batchSize)
...
func (a activityLogDo) FindInBatches(result *[]*entity.ActivityLog, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (a activityLogDo) FirstOrInit() (*entity.ActivityLog, error) {
...
func (a activityLogDo) FirstOrCreate() (*entity.ActivityLog, error) {
...
func (a activityLogDo) FindByPage(offset int, limit int) (result []*entity.ActivityLog, count int64, err error) {
...
func (a activityLogDo) Delete(models ...*entity.ActivityLog) (result gen.ResultInfo, err error) {

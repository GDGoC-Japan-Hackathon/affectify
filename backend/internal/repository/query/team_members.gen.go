...
func newTeamMember(db *gorm.DB, opts ...gen.DOOption) teamMember {
	...
	_teamMember.teamMemberDo.UseModel(&entity.TeamMember{})
	...
	_teamMember.UserID = field.NewInt64(tableName, "user_id")
	_teamMember.JoinedAt = field.NewTime(tableName, "joined_at")
...
func (t *teamMember) WithContext(ctx context.Context) ITeamMemberDo {
	return t.teamMemberDo.WithContext(ctx)
}

func (t teamMember) TableName() string { return t.teamMemberDo.TableName() }

func (t teamMember) Alias() string { return t.teamMemberDo.Alias() }

func (t teamMember) Columns(cols ...field.Expr) gen.Columns { return t.teamMemberDo.Columns(cols...) }
...
type ITeamMemberDo interface {
	...
	Create(values ...*entity.TeamMember) error
	CreateInBatches(values []*entity.TeamMember, batchSize int) error
	Save(values ...*entity.TeamMember) error
	First() (*entity.TeamMember, error)
	Take() (*entity.TeamMember, error)
	Last() (*entity.TeamMember, error)
	Find() ([]*entity.TeamMember, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*entity.TeamMember, err error)
	FindInBatches(result *[]*entity.TeamMember, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*entity.TeamMember) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*entity.TeamMember, error)
	FirstOrCreate() (*entity.TeamMember, error)
	FindByPage(offset int, limit int) (result []*entity.TeamMember, count int64, err error)
...
func (t teamMemberDo) Create(values ...*entity.TeamMember) error {
	if len(values) == 0 {
		return nil
	}
...
func (t teamMemberDo) CreateInBatches(values []*entity.TeamMember, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t teamMemberDo) Save(values ...*entity.TeamMember) error {
	if len(values) == 0 {
		return nil
	}
...
func (t teamMemberDo) First() (*entity.TeamMember, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*entity.TeamMember), nil
	}
}

func (t teamMemberDo) Take() (*entity.TeamMember, error) {
...
func (t teamMemberDo) Last() (*entity.TeamMember, error) {
...
func (t teamMemberDo) Find() ([]*entity.TeamMember, error) {
	result, err := t.DO.Find()
	return result.([]*entity.TeamMember), err
}

func (t teamMemberDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*entity.TeamMember, err error) {
	buf := make([]*entity.TeamMember, 0, batchSize)
...
func (t teamMemberDo) FindInBatches(result *[]*entity.TeamMember, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t teamMemberDo) FirstOrInit() (*entity.TeamMember, error) {
...
func (t teamMemberDo) FirstOrCreate() (*entity.TeamMember, error) {
...
func (t teamMemberDo) FindByPage(offset int, limit int) (result []*entity.TeamMember, count int64, err error) {
...
func (t teamMemberDo) Delete(models ...*entity.TeamMember) (result gen.ResultInfo, err error) {

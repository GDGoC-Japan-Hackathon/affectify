locals {
  ...
  backend_service_account_id = "whitecoder-backend-prod"
  github_deployer_sa_id      = "whitecoder-gh-deployer-prod"
}
...
module "secret_manager" {
  ...
  secret_versions = {
    "db-password-prod"                = var.cloud_sql_user_password
    "firebase-admin-credentials-prod" = var.firebase_admin_credentials_json
  }
...
resource "google_service_account" "backend" {
  ...
  display_name = "WhiteCoder Backend (prod)"
...
resource "google_service_account" "github_deployer" {
  ...
  display_name = "WhiteCoder GitHub Deployer (prod)"
...
module "cloud_run" {
  ...
  secret_env = {
    ...
    FIREBASE_CREDENTIALS_JSON = "firebase-admin-credentials-prod"
  }
  env = {
